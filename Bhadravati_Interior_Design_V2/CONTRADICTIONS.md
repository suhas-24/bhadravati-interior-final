...
- **Idria Oak · 84689 SU** — category Woodgrains | European Grey; size 8 ft ? 4 ft; thickness **0.8 mm**. Evidence: `source/century_84689_idria_oak_website_2026-08-12.png`. Full write-up: `IDRIA_REVALIDATION.md`.

**Resolution:** Preferred = **84689 SU Idria Oak** (catalogue + website confirmed). Lyon **84687** = backup only after sample failure / client choice. Challenge closed — **not a wrong SKU**.

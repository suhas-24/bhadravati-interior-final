...
| | |
|---|---|
| **Skills** | `interior-design-fundamentals`, `interior-design-advisor` |
| **Role** | Concept Director |
| **Decisions** | Hierarchy architecture ? joinery ? textiles ? accents; granite + quiet greige emphasis; no TV feature wall |
| **PDF** | Non-negotiables + concept decision table |
...
| | |
|---|---|
| **Skills** | `interior-color-theory` |
| **Role** | Materials Lead |
| **Decisions** | Scheme A default NN9074+WW0005; Scheme B alt NN9088+WW0020; metamerism sample plan at 3000 K (C-04) |
| **PDF** | Swatches + palette table + A/B comparison pages |
...
| | |
|---|---|
| **Skills** | `materials-finishes-textiles`, `sustainability-wellness-ieq` |
| **Role** | Materials Lead |
| **Decisions** | S1241 MT Latte all kitchen (C-03); 84689 Idria preferred / 84687 backup (C-07); 80236 TV only; E3 2/1 mm; recessed SS (C-08); C-09 finish lock vs aluminium system nuance |
| **PDF** | Locked materials table |
...
| | |
|---|---|
| **Skills** | `interior-lighting-design` |
| **Role** | Lighting Designer |
| **Decisions** | 3000 K baseline; CRI ?90 preferred; kitchen under-loft task mandatory; lux guidance ranges |
| **PDF** | Lighting narrative + evening junction image |
...
| **PDF** | Living / kitchen / scheme / wardrobe views + boards 01–05 elevations/QA |
...
| | |
|---|---|
| **Skills** | `3d-modeling-rendering`, `ai-generative-interior-design` |
| **Role** | 3D / Render Artist |
| **Decisions** | Reused QA-passed V1 visuals (3-door, recessed, Latte-all); captions mark schematic loft bands |
| **PDF** | Three-view sets + Option A/B |
...
| | |
|---|---|
| **Skills** | `cad-bim-technical-drafting` |
| **Role** | Documentation Drafter |
| **Decisions** | Relational plan SVG/JPG retained; dual units; existing granite vs new shutters |
| **PDF** | Floor plan page |
...
| | |
|---|---|
| **Skills** | `construction-documents-specs` |
| **Role** | Documentation Drafter |
| **Decisions** | Design-control ? shop drawings; finish schedule matches locks; clear openings ? cut list |
| **PDF** | Dimension + materials schedules |
...
| | |
|---|---|
| **Skills** | `visualization-presentation`, `client-discovery-communication`, `construction-documents-specs`, `interior-design-advisor` |
| **Role** | Handover Editor ? PDF synthesis lead |
| **Decisions** | V2 PDF is the client handoff; companions: MASTER_BRIEF_V2, SOURCE_OF_TRUTH, PHASE_FRAMEWORK |
| **PDF** | Full document + next 3 actions |
...
| | |
|---|---|
| **Skills** | `portfolio-trends-pro-development` |
| **Role** | Portfolio Curator |
| **Decisions** | Case note: resilient Indian home; V2 fixed four-leaf drift, dual-tone contradiction, NN9088-default confusion |
| **PDF** | Closing case-study note |
...
Built against verified sources first; then reconciled to Methodology (`SKILLS_INVENTORY`, `PHASE_FRAMEWORK`, `TEAM_ROLES`) and Spec audit (`SOURCE_OF_TRUTH`, `V1_BASELINE`, `CONTRADICTIONS`). Asset refresh: client PDF embeds `ASSET_INDEX` primaries 01–05 (palette, floorplan, kitchen elevation, 3-door wardrobe elevation, QA sheet); excludes 02b/04b/05b. Room renders remain under `assets/img/`.

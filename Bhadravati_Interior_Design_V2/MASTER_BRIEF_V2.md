...
Sources of truth (in priority order): signed site measure (when complete) ? `interior_dimension_control/dimension_register_v1` ? this brief + `source/design_tokens_v2.json` ? prior PDFs/renders (context only).
...
- **Living:** wipeable taupe sofa ~2100�2200 mm; �700�800 coffee table; floating TV cabinet 1400�1800 mm; low-pile rug; no TV wall cladding.
...
## 7. Climate, durability, and IEQ (Bhadravati)

Dust/smoke, laterite dust, hard water, hot summers, monsoon humidity, strong daylight. Response: mid-tone greige walls, matte wipeable joinery, sealed wet-risk boards, limited open shelving, serviceable recessed hardware, spare laminate retained, 3000 K high-CRI light, daylight preserved with sheer/curtain control.
